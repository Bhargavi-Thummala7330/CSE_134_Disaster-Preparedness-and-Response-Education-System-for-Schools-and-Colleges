...
$check = $conn->query("SELECT * FROM quiz_results WHERE user_id='$user_id' AND disaster='heatwave'");
$quiz_completed = ($check->num_rows > 0);

if ($quiz_completed) {
    header("Location: heatwave_quiz_review.php");
    exit();
}

// Heatwave Questions
$questions = [
1 => ["question"=>"Hydration?","options"=>["Drink water"=>1,"Avoid water"=>0]],
2 => ["question"=>"Stay indoors?","options"=>["Yes"=>1,"No"=>0]],
3 => ["question"=>"Sun exposure?","options"=>["Avoid"=>1,"Stay long"=>0]],
4 => ["question"=>"Clothing?","options"=>["Light"=>1,"Heavy"=>0]],
5 => ["question"=>"Time outside?","options"=>["Morning/Evening"=>1,"Noon"=>0]],
6 => ["question"=>"Check others?","options"=>["Yes"=>1,"No"=>0]],
7 => ["question"=>"AC/fans?","options"=>["Use"=>1,"Avoid"=>0]],
8 => ["question"=>"Food?","options"=>["Light meals"=>1,"Heavy meals"=>0]],
9 => ["question"=>"Symptoms?","options"=>["Recognize"=>1,"Ignore"=>0]],
10=> ["question"=>"Stay cool?","options"=>["Yes"=>1,"No"=>0]]
];
?>
...
<p>Test your knowledge - 10 questions, 70% to pass</p>
        ...
        <div class="quiz-content">
            ...
            <form action="submit_quiz.php" method="POST" id="quizForm">
                ...
                <input type="hidden" name="disaster" value="heatwave">
