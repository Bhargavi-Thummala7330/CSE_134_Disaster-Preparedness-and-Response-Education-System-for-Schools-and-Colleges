...
<head>
    ...
    <title>Flood Preparedness Training - Disaster Ready India</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="hero">
            ...
            <h1>Flood Preparedness Training</h1>
            <p>Learn how to protect yourself and others during flood events</p>
        </div>
    ...
    <p>Immediately move to higher areas away from floodwaters.</p>
</div>

<div class="point-card">
    <div class="point-icon">⚡</div>
    <h3>Avoid Electrical Areas</h3>
    <p>Stay away from electric poles and wires in water.</p>
</div>

<div class="point-card">
    <div class="point-icon">🚗</div>
    <h3>Do Not Drive in Flood</h3>
    <p>Even shallow water can sweep away vehicles.</p>
</div>

<div class="point-card">
    <div class="point-icon">📻</div>
    <h3>Stay Updated</h3>
    <p>Listen to alerts and evacuation instructions.</p>
</div>

<div class="point-card">
    <div class="point-icon">🧴</div>
    <h3>Keep Emergency Kit</h3>
    <p>Carry water, food, medicines, and torch.</p>
</div>

<div class="point-card">
    <div class="point-icon">🚫</div>
    <h3>Avoid Walking in Water</h3>
    <p>Floodwater may hide dangers like drains or debris.</p>
</div>
            </div>
        </div>
        ...
        <div class="video-section">
            ...
            <div class="video-container">
                <video controls poster="../assets/images/flood-poster.jpg">
                    <source src="../assets/videos/flood.mp4" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
            </div>
            <div class="video-tips">
                <i class="fas fa-lightbulb"></i>
                <span>💡 Pro Tip: Watch the video carefully. Pay attention to the "Drop, Cover, and Hold On" technique - it's the most important safety measure during floods!</span>
            </div>
        </div>
        ...
        <?php if (!$quiz_completed): ?>
            <div class="quiz-action">
                ...
                <p>Complete the quiz to earn your certificate and become flood ready!</p>
        ...
        <?php else: ?>
            ...
            <div class="review-section">
                ...
                <div class="review-buttons">
                    <a href="flood_quiz_review.php" class="review-btn review-quiz-btn" target="_blank">
                        <i class="fas fa-eye"></i> Review Your Answers
                    </a>
                    <?php if ($user_percentage >= 70): ?>
                        <a href="certificate.php?disaster=flood&score=<?php echo $user_score; ?>&total=<?php echo $user_total; ?>" class="review-btn certificate-btn" target="_blank">
...
window.open('flood_quiz.php', '_blank');        }
