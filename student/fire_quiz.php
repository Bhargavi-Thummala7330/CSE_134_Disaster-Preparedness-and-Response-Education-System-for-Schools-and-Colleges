...
// Flood Questions
$questions = [
1 => ["question"=>"What to do during fire?","options"=>["Use extinguisher"=>1,"Panic"=>0]],
2 => ["question"=>"Avoid?","options"=>["Smoke inhalation"=>1,"Fresh air"=>0]],
3 => ["question"=>"Emergency number?","options"=>["101"=>1,"100"=>0]],
4 => ["question"=>"Clothes on fire?","options"=>["Stop Drop Roll"=>1,"Run"=>0]],
5 => ["question"=>"Use elevator?","options"=>["No"=>1,"Yes"=>0]],
6 => ["question"=>"Check doors?","options"=>["Yes"=>1,"No"=>0]],
7 => ["question"=>"Smoke rises?","options"=>["Stay low"=>1,"Stand tall"=>0]],
8 => ["question"=>"Fire alarm?","options"=>["Activate"=>1,"Ignore"=>0]],
9 => ["question"=>"Escape plan?","options"=>["Yes"=>1,"No"=>0]],
...
<p>Test your knowledge - 10 questions, 70% to pass</p>
        ...
        <div class="quiz-content">
            ...
            <form action="submit_quiz.php" method="POST" id="quizForm">
                ...
                <input type="hidden" name="disaster" value="fire">
