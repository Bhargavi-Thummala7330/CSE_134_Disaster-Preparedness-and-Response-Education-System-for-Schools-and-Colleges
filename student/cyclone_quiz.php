...
// Flood Questions
$questions = [
1 => ["question"=>"Before cyclone?","options"=>["Prepare supplies"=>1,"Ignore"=>0]],
2 => ["question"=>"Stay indoors?","options"=>["Yes"=>1,"No"=>0]],
3 => ["question"=>"Windows?","options"=>["Close tightly"=>1,"Open"=>0]],
4 => ["question"=>"Flood risk?","options"=>["High"=>1,"None"=>0]],
5 => ["question"=>"Emergency kit?","options"=>["Yes"=>1,"No"=>0]],
6 => ["question"=>"Electric wires?","options"=>["Avoid"=>1,"Touch"=>0]],
7 => ["question"=>"Follow alerts?","options"=>["Yes"=>1,"No"=>0]],
8 => ["question"=>"Travel?","options"=>["Avoid"=>1,"Continue"=>0]],
9 => ["question"=>"Shelter?","options"=>["Safe place"=>1,"Outside"=>0]],
...
<p>Test your knowledge - 10 questions, 70% to pass</p>
        ...
        <div class="quiz-content">
            ...
            <form action="submit_quiz.php" method="POST" id="quizForm">
                ...
                <input type="hidden" name="disaster" value="cyclone">
