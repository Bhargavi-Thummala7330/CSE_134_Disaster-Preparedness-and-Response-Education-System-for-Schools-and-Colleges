...
// Drought Questions
$questions = [
1 => ["question"=>"Water saving?","options"=>["Yes"=>1,"Waste"=>0]],
2 => ["question"=>"Rainwater harvesting?","options"=>["Yes"=>1,"No"=>0]],
3 => ["question"=>"Irrigation?","options"=>["Efficient"=>1,"Flooding"=>0]],
4 => ["question"=>"Food storage?","options"=>["Yes"=>1,"No"=>0]],
5 => ["question"=>"Government alerts?","options"=>["Follow"=>1,"Ignore"=>0]],
6 => ["question"=>"Water reuse?","options"=>["Yes"=>1,"No"=>0]],
7 => ["question"=>"Crop planning?","options"=>["Yes"=>1,"No"=>0]],
8 => ["question"=>"Avoid waste?","options"=>["Yes"=>1,"No"=>0]],
9 => ["question"=>"Emergency plan?","options"=>["Yes"=>1,"No"=>0]],
10=> ["question"=>"Stay aware?","options"=>["Yes"=>1,"No"=>0]]
];
?>
...
<p>Test your knowledge - 10 questions, 70% to pass</p>
        ...
        <div class="quiz-content">
            ...
            <form action="submit_quiz.php" method="POST" id="quizForm">
                ...
                <input type="hidden" name="disaster" value="drought">
