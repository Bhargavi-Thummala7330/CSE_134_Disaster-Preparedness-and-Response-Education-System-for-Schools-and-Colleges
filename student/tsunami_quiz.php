...
// Tsunami Questions
$questions = [
1 => ["question"=>"Tsunami warning?","options"=>["Move inland"=>1,"Stay beach"=>0]],
2 => ["question"=>"After earthquake near sea?","options"=>["Run inland"=>1,"Wait"=>0]],
3 => ["question"=>"Wave height?","options"=>["Very high"=>1,"Small"=>0]],
4 => ["question"=>"Emergency kit?","options"=>["Yes"=>1,"No"=>0]],
5 => ["question"=>"Stay informed?","options"=>["Yes"=>1,"No"=>0]],
6 => ["question"=>"Return early?","options"=>["No"=>1,"Yes"=>0]],
7 => ["question"=>"Evacuation?","options"=>["Immediate"=>1,"Delay"=>0]],
8 => ["question"=>"Climb?","options"=>["Higher ground"=>1,"Stay low"=>0]],
9 => ["question"=>"Warning sirens?","options"=>["Follow"=>1,"Ignore"=>0]],
...
<p>Test your knowledge - 10 questions, 70% to pass</p>
        ...
        <div class="quiz-content">
            ...
            <form action="submit_quiz.php" method="POST" id="quizForm">
                ...
                <input type="hidden" name="disaster" value="tsunami">
