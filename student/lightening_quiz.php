...
// Lightning Questions - FIXED Question 10
$questions = [
    1 => ["question" => "During lightning?", "options" => ["Stay indoors" => 1, "Go outside" => 0]],
    2 => ["question" => "Avoid trees?", "options" => ["Yes" => 1, "No" => 0]],
    3 => ["question" => "Water safety?", "options" => ["Avoid" => 1, "Safe" => 0]],
    4 => ["question" => "Electronics?", "options" => ["Unplug" => 1, "Use" => 0]],
    5 => ["question" => "Open fields?", "options" => ["Avoid" => 1, "Stay" => 0]],
    6 => ["question" => "Shelter?", "options" => ["Building" => 1, "Open area" => 0]],
    7 => ["question" => "Metal objects?", "options" => ["Avoid" => 1, "Touch" => 0]],
    8 => ["question" => "Wait after storm?", "options" => ["Yes" => 1, "No" => 0]],
    9 => ["question" => "Emergency help?", "options" => ["Call" => 1, "Ignore" => 0]],
    10 => ["question" => "Stay calm?", "options" => ["Yes" => 1, "No" => 0]]  // FIXED: Yes should be 1, No should be 0
];
?>

<!-- Rest of your quiz HTML remains the same -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<p>Test your knowledge - 10 questions, 70% to pass</p>
        ...
        <div class="quiz-content">
            ...
            <form action="submit_quiz.php" method="POST" id="quizForm">
                ...
                <input type="hidden" name="disaster" value="lightening">
