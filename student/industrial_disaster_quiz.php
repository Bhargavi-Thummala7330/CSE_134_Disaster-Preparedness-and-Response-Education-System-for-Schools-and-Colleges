...
$check = $conn->query("SELECT * FROM quiz_results WHERE user_id='$user_id' AND disaster='industrial'");
$quiz_completed = ($check->num_rows > 0);

if ($quiz_completed) {
    header("Location: industrial_disaster_quiz_review.php");
    exit();
}

// Industrial Disaster Questions
$questions = [
1 => ["question"=>"Chemical leak?","options"=>["Evacuate"=>1,"Stay"=>0]],
2 => ["question"=>"Mask?","options"=>["Use"=>1,"No"=>0]],
3 => ["question"=>"Follow authorities?","options"=>["Yes"=>1,"No"=>0]],
4 => ["question"=>"Close windows?","options"=>["Yes"=>1,"No"=>0]],
5 => ["question"=>"Emergency kit?","options"=>["Yes"=>1,"No"=>0]],
6 => ["question"=>"Avoid area?","options"=>["Yes"=>1,"No"=>0]],
7 => ["question"=>"Inform others?","options"=>["Yes"=>1,"No"=>0]],
8 => ["question"=>"Stay calm?","options"=>["Yes"=>1,"No"=>0]],
9 => ["question"=>"Medical help?","options"=>["Yes"=>1,"No"=>0]],
10=> ["question"=>"Safety training?","options"=>["Yes"=>1,"No"=>0]]
];
?>
...
<p>Test your knowledge - 10 questions, 70% to pass</p>
        ...
        <div class="quiz-content">
            ...
            <form action="submit_quiz.php" method="POST" id="quizForm">
                ...
                <input type="hidden" name="disaster" value="industrial">
