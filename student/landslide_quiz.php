...
$check = $conn->query("SELECT * FROM quiz_results WHERE user_id='$user_id' AND disaster='landslide'");
$quiz_completed = ($check->num_rows > 0);

if ($quiz_completed) {
    header("Location: landslide_quiz_review.php");
    exit();
}

// Landslide Questions
$questions = [
1 => ["question"=>"During landslide?","options"=>["Move away"=>1,"Stay still"=>0]],
2 => ["question"=>"Warning signs?","options"=>["Cracks"=>1,"None"=>0]],
3 => ["question"=>"Heavy rain risk?","options"=>["Yes"=>1,"No"=>0]],
4 => ["question"=>"Safe area?","options"=>["High ground"=>1,"Slope"=>0]],
5 => ["question"=>"Emergency kit?","options"=>["Yes"=>1,"No"=>0]],
6 => ["question"=>"Drive?","options"=>["Avoid"=>1,"Continue"=>0]],
7 => ["question"=>"Listen alerts?","options"=>["Yes"=>1,"No"=>0]],
8 => ["question"=>"Stay indoors?","options"=>["Safe building"=>1,"Outside"=>0]],
9 => ["question"=>"Protect head?","options"=>["Yes"=>1,"No"=>0]],
10=> ["question"=>"Stay calm?","options"=>["Yes"=>1,"No"=>0]]
];
?>
...
<p>Test your knowledge - 10 questions, 70% to pass</p>
        ...
        <div class="quiz-content">
            ...
            <form action="submit_quiz.php" method="POST" id="quizForm">
                ...
                <input type="hidden" name="disaster" value="landslide">
